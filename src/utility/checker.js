var Men = require('../Json/Men.json');
var Women = require('../Json/Women.json');
var Children = require('../Json/Children.json');

const fiilter = (size="XX-L", gender="Men", colour="blue") => {
    const helper = []
